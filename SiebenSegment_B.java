 ...
 * @author Hans Witt
 * 
 *         Version: 1.1 (14.7.2008) Hinzufügen von Statusvariablen für Position
 *         ...
 * 
 *         Version: 3 (12.8.2008) ergänzt für Containerklasse für GUI-Elemente
...
public class SiebenSegment_B implements IComponente{
	...
	// Positionen werden benötigt für Größe ändern
	int positionX = 0;
	int positionY = 0;
